...
/**
 * REST controller for managing {@link com.gksoft.application.domain.Bid}.
 */
@RestController
@RequestMapping("/api")
public class BidResource {
     ...
     */
    @GetMapping("/bids")
    public ResponseEntity<List<Bid>> getAllBids(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
