...
import com.gksoft.application.repository.CountryRepository;
import com.gksoft.application.service.CountryService;
...
/**
 * REST controller for managing {@link com.gksoft.application.domain.Country}.
 */
@RestController
@RequestMapping("/api")
