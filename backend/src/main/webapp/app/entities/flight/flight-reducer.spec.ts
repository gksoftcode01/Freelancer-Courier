...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './flight.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLIGHT_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLIGHT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLIGHT actions', async () => {
      const expectedActions = [
        {
