...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMTYPES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ITEMTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ITEMTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ITEMTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ITEMTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ITEMTYPES actions', async () => {
      const expectedActions = [
        {
