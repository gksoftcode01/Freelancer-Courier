...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cargo-request-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARGOREQUESTDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARGOREQUESTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARGOREQUESTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARGOREQUESTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARGOREQUESTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARGOREQUESTDETAILS actions', async () => {
      const expectedActions = [
        {
