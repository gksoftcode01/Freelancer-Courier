...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARGOREQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARGOREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARGOREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARGOREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARGOREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARGOREQUEST actions', async () => {
      const expectedActions = [
        {
