...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ask.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASK_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASK actions', async () => {
      const expectedActions = [
        {
