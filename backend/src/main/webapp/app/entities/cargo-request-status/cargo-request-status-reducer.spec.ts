...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cargo-request-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARGOREQUESTSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARGOREQUESTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARGOREQUESTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARGOREQUESTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARGOREQUESTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARGOREQUESTSTATUS actions', async () => {
      const expectedActions = [
        {
