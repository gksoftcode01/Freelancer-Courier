...
export const AppUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="freelancerCourierApp.appUser.delete.question">
        <Translate contentKey="freelancerCourierApp.appUser.delete.question" interpolate={{ id: appUserEntity.id }}>
