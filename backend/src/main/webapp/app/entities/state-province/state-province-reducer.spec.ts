...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATEPROVINCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STATEPROVINCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STATEPROVINCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STATEPROVINCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STATEPROVINCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STATEPROVINCE actions', async () => {
      const expectedActions = [
        {
