...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './user-rate.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERRATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERRATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERRATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERRATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERRATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERRATE actions', async () => {
      const expectedActions = [
        {
