...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="freelancerCourierApp.country.delete.question">
        <Translate contentKey="freelancerCourierApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
